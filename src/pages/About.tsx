    ...
    <Container maxWidth="lg" sx={{ py: 8 }} dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ textAlign: isRTL ? 'right' : 'left' }}>
            <DebugTooltip jsonPath="about_self.json > text (paragraph 1)">
              <Typography variant="h2" color="primary" sx={{ mb: 3, fontWeight: 'bold', fontSize: { xs: '2rem', md: '2.5rem' } }}>
                היי, אני מאריאנה שחם.
              </Typography>
            </DebugTooltip>
            ...
            <DebugTooltip jsonPath="about_self.json > text (paragraph 3)">
              <Typography variant="h5" color="primary" sx={{ mb: 3, fontWeight: 'medium', fontStyle: 'italic' }}>
            ...
            <DebugTooltip jsonPath="about_self.json > text (paragraph 6)">
              <Typography variant="body1" color="primary" sx={{ mb: 3, fontWeight: 'medium', lineHeight: 1.8, fontSize: '1.1rem' }}>
      ...
      <Box sx={{ mt: 8, p: 4, backgroundColor: 'rgba(212, 165, 165, 0.05)', borderRadius: '20px' }}>
        <DebugTooltip jsonPath="about_self.json > text (paragraph 7)">
          <Typography variant="h5" color="text.primary" sx={{ mb: 3, textAlign: 'center', lineHeight: 1.6, fontWeight: 'medium' }}>
      ...
      <Box sx={{ mt: 8 }}>
        <Paper elevation={3} sx={{ p: 4, borderRadius: '20px' }}>
          <DebugTooltip jsonPath="about_self.json > text (paragraph 8)">
            <Typography variant="h6" color="text.primary" sx={{ mb: 3, textAlign: isRTL ? 'right' : 'left', lineHeight: 1.8, fontSize: '1.2rem' }}>
          ...
          <DebugTooltip jsonPath="about_self.json > text (paragraph 9)">
            <Typography variant="body1" sx={{ mb: 3, textAlign: isRTL ? 'right' : 'left', lineHeight: 1.8, fontSize: '1.1rem' }}>
          ...
          <DebugTooltip jsonPath="about_self.json > text (paragraph 10)">
            <Typography variant="h5" color="primary" sx={{ textAlign: 'center', fontWeight: 'medium', fontStyle: 'italic', fontSize: '1.3rem' }}>
